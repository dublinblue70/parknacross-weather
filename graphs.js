(() => {
 ...
 function updateChartAccessibility(periodLabel,rowCount,coverage){
   const labels={gTemp:"Temperature and dew point",gWind:"Wind speed and gusts",gPressure:"Sea-level pressure",gRain:"Rain rate",gSolar:"Solar radiation and UV",gWindRose:"Wind direction frequency",gSoilMoisture:"Soil moisture",gSoilDetail:"Soil temperature and conductivity"};
