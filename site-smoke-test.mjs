...
const requiredChecks = [
  ...
  ["service-worker.js", "parknacross-v38-4-96"],
...
if (!dashboardHtml.includes('data-corrections.js?v=20260924-v38-4-96')) failures.push("index.html: shared data corrections must load before the dashboard application");
